...
if simnum==1
text(currax,-163.5,24.5,{'Long_{E}:', [num2str(EvLon) '^\circ']},'fontsize',17,'fontweight','bold','color','magenta')
text(currax,-163.5,18,{'Lat_{E}:', [num2str(EvLat) '^\circ']},'fontsize',17,'fontweight','bold','color','magenta')
end

if simnum==2
text(currax,-163.5,24.5,{'Long_{E}:', [num2str(EvLon) '^\circ']},'fontsize',17,'fontweight','bold','color','magenta')
text(currax,-163.5,18,{'Lat_E:', [num2str(EvLat) '^\circ']},'fontsize',17,'fontweight','bold','color','magenta')
end

if simnum==3
text(currax,-163.5,24.5,{'Long_E:',[ num2str(EvLon) '^\circ']},'fontsize',17,'fontweight','bold','color','magenta')
text(currax,-163.5,18,{'Lat_E:', [ num2str(EvLat) '^\circ']},'fontsize',17,'fontweight','bold','color','magenta')
end


if simnum==4
text(currax,-163.5,24.5,{'Width:',[ num2str(2*current_width) ' km']},'fontsize',17,'fontweight','bold','color','magenta')
end
...
if simnum==7
text(currax,-163.5,24.5,{'\tau_{max}: ', [num2str(current_timelag) ' s']},'fontsize',17,'fontweight','bold','color','magenta')
end

function [s,az] = vdist(lat1,lon1,lat2,lon2)
...
%
% [s,az] = vdist(lat1,lon1,lat2,lon2)
%
% s  = distance in kilometers
% az = azimuth from pt1 to pt2
...
% =====================================================================
% Vicenty's azimuth calculation code:

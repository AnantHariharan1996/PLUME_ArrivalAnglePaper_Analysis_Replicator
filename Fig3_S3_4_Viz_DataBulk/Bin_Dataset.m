function [ Binned_Vector_Median,Binned_Vector_UpperQ,Binned_Vector_LowerQ,lenlist,Binned_Vector_Mean ] = ...
...
for BinLoc = XvecBinLocs
    ...
    Binned_Vector_Median(bcounter) = nanmedian(Yvec(idx));
   ...
   lenlist(bcounter) = length(idx);
    Binned_Vector_Mean(bcounter) = nanmean(Yvec(idx));

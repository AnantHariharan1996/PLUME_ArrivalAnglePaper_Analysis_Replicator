...
doubcounter=doubcounter+1;
MegaDoubIDLIST = [MegaDoubIDLIST doubcounter.*ones(size(Arrival_Angle_Store_1))];
...
hold on
scatter(MegaAAList_Sta1,MegaAAList_Sta2,150,MegaDoubIDLIST,'filled','MarkerEdgeColor','k','linewidth',1)
...
scatter(MegaAAList_Sta1,MegaAAList_Sta2,500,MegaDoubIDLIST,'filled','MarkerEdgeColor','k','linewidth',1)
...
barbar=colorbar;
ylabel(barbar,'Doublet ID')
saveas(gcf,'Fig7_ColorDoublet.png')
